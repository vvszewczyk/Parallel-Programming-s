...
----------------------------------------------------------*/
void sortowanie_przez_scalanie(double *A, /* in: tablica fragment ktorej ma zostac posortowany */
...
/*---------------------------------------------------------
  sortowanie_szybkie - procedura sortuje czesc tablicy A
                       od indeksu p do indeksu q
---------------------------------------------------------*/
void sortowanie_szybkie(double *A, /* tablica fragment ktorej ma zostac posortowany */
