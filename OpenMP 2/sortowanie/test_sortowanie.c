...
int main(int argc, char **argv)
{
    ...
    qsort((void *)&A[1], (size_t)n, (size_t)sizeof(double), (int (*)(const void *, const void *))porownaj);

    printf("qsort\tczas sortowania systemowego: %lf\n", getdaytime() - czas);
    ...
    printf("sortowanie_przez_scalanie\tczas sortowania przez scalanie: %lf\n", getdaytime() - czas);
    ...
    printf("sortowanie_szybkie\tczas sortowania szybkiego: %lf\n", getdaytime() - czas);
...
#pragma omp single
    ...
    printf("merge_sort_openmp\tczas rownoleglego sortowania przez scalanie: %lf\n", getdaytime() - czas);
...
#pragma omp single
    ...
    printf("merge_sort_openmp_2\tczas rownoleglego sortowania przez scalanie (final): %lf\n", getdaytime() - czas);
    ...
    printf("merge_sort_openmp_4\tczas rownoleglego sortowania przez scalanie (nested): %lf\n", getdaytime() - czas);
